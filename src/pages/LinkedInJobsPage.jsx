import { Search, Linkedin as LinkedinIcon, Sparkles, Loader } from 'lucide-react'
...
export default function LinkedInJobsPage() {
    ...
    const handleShowMatchedJobs = async () => {
        ...
        try {
            const response = await cvAPI.getMatchedLinkedInJobs(1, 12)
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            {matchedLoading && (
                <Card className="animate-fade-in">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-surface-200">Processing your CV against LinkedIn jobs...</p>
            ...
            {displayLoading && !matchedLoading ? (
                ...
                <EmptyState
                    icon={LinkedinIcon}
                    title={showMatchedJobs ? 'No matched LinkedIn jobs found' : 'No LinkedIn jobs found'}

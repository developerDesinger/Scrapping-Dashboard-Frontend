import { Globe, Sparkles, Loader } from 'lucide-react'
...
export default function LintbergJobsPage() {
    ...
    const handleShowMatchedJobs = async () => {
        ...
        try {
            const response = await cvAPI.getMatchedLintbergJobs(1, 12)
    ...
    return (
        <div className="space-y-6 animate-fade-in">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-surface-500 mt-0.5">
                            {showMatchedJobs
                                ...
                                : total > 0 ? `${total} jobs found from Lintberg` : 'Discover matched jobs from Lintberg'}
                        </p>
                    </div>
                </div>
                <Button 
            ...
            {matchedLoading && (
                <Card className="animate-fade-in">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-surface-200">Processing your CV against Lintberg jobs...</p>
            ...
            {displayLoading && !matchedLoading ? (
                ...
                <EmptyState
                    icon={Globe}
                    title={showMatchedJobs ? 'No matched Lintberg jobs found' : 'No Lintberg jobs found'}
